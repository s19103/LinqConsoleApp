    ...
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task4()
        {
            ...
            var res = Emps.Where(emp => emp.Salary == maxSal);           
        }
        ...
        public void Task7()
        {
            var res = Emps.Select(emp => new
            {
                EmplyeeJob = Emps.GroupBy(emp => emp.Job),
        ...
        public void Task9()
        {
            var res = Emps.Where(emp => emp.Job == "Fronted programmer")
        ...
        public void Task11()
        {
            ...
            var res = Emps.Aggregate((agg, emp) => agg.Salary > emp.Salary ? agg : emp);
        }
